...
class MyClassifier(OpenAttack.Classifier):
        ...
        # def mapping_hugging(self, example):
        #     ret = self.tokenizer(example['text'], padding = 'max_length', truncation=True)
        #     return ret

        def get_pred(self, input_):
            if self.model_name in ['roberta-base','bert-base','distilroberta-base']:
